import { CountContextProps } from "@/interfaces";
...
export const CountProvider =  ({children}: {children: ReactNode}) => {
    ...
    return  (
        <CountContext.Provider value={{count, increment, decrement}}>{children}</CountContext.Provider>
    )
}
...
export const useCount = () => {
    ...
    if (!context) {
        throw new Error("useContxt must be within a count Provier")
    }
    return  context
}